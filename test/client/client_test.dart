...
void main() {
  var client;
  setUp(() => client = Client(Uri.parse('ws://localhost:15566/kpi/rpc')));

  test('subscrib to queueing signal', ()  {
    final sub = client.subscribe('/QueueingSync');

    expect(sub.stream.stream.listen((event) {
      print(event);
      return event;
    }, completes);
